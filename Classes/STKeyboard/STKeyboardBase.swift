...
class STKeyboardBase: UIView {
   ...
   * Input
   */
  func setInputViewToView(_ view: UIView?) {
  ...
  func attachToTextInput(textInput: UITextInput) {
  ...
  func replaceText(inRange range: UITextRange?, withText text: String) {
  ...
  func textInputShouldReplaceText(inRange range: UITextRange, replacementText text: String) -> Bool {
    if let textInput = self.textInput {
